...
/// <summary>
/// Unit MVCBr.View implementas os objeto Factory para a camada de visualiza��o
/// </summary>
unit MVCBr.View;
{ *************************************************************************** }
{ }
...
type
  ...
  /// <summary>
  /// TViewFactory � um Factory abstrato a ser utilizado com finalidades genericas
  /// sem liga��o direta com um visualizador
  /// </summary>
