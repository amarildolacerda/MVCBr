...
class function TMVCSupportZLib.ZCompressString(aText: string): TBytes;
var
...
class function TMVCSupportZLib.ZDecompressString(aText: TBytes): string;
var
  strInput: TBytesStream;
  strOutput: TBytesStream;
