...
uses
  ...
  System.RTTI, TabControlNav.Controller.Interf, TabControlNav.ViewModel,
  TabControlNav.ViewModel.Interf,
  TabControlNavView;

type
  TTabControlNavController = class(TControllerFactory, ITabControlNavController,
...
begin
  ...
  view(TTabControlNavView.New(self));
  add(TTabControlNavViewModel.New(self).ID('{TabControlNav.ViewModel}'));
...
class function TTabControlNavController.New(const AModel: IModel): IController;
begin
...
RegisterInterfacedClass(TTabControlNavController.ClassName,
  ITabControlNavController, TTabControlNavController);
