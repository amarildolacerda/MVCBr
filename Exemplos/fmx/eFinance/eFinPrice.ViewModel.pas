...
///  Object Factory para o ViewModel
    TeFinPriceViewModel=class(TViewModelFactory,
      IeFinPriceViewModel, IViewModelAs<IeFinPriceViewModel>)
    public
      function ViewModelAs:IeFinPriceViewModel;
      class function new():IeFinPriceViewModel;overload;
      class function new(const AController:IController):IeFinPriceViewModel; overload;
...
///   ligado
/// </param>
class function TeFinPriceViewModel.new(const AController:IController):IeFinPriceViewModel;
begin
