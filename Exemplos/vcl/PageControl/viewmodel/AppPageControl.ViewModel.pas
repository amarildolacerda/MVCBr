...
///  Object Factory para o ViewModel
    TAppPageControlViewModel=class(TViewModelFactory,
      IAppPageControlViewModel, IViewModelAs<IAppPageControlViewModel>)
    public
      function ViewModelAs:IAppPageControlViewModel;
      class function new():IAppPageControlViewModel;overload;
      class function new(const AController:IController):IAppPageControlViewModel; overload;
...
///   ligado
/// </param>
class function TAppPageControlViewModel.new(const AController:IController):IAppPageControlViewModel;
begin
