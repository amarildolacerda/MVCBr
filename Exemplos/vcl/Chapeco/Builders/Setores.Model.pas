...
Type
 ...
 TSetoresModel = class(TModelBuilderFactory,
                ISetoresModel, IThisAs<TSetoresModel>)
 protected
    procedure CreateSubClasses; override;
 public
    class function new(): ISetoresModel; overload;
    class function new(const AController: IController):
ISetoresModel; overload;
...
class function TSetoresModel.new(const AController:IController)
             : ISetoresModel;
begin
