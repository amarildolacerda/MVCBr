...
/// </summary>
unit ComoEnviarMensagemParaOutraView.ViewModel.Interf;
interface
uses MVCBr.Interf, MVCBr.ViewModel;
Type
///  Interaface para o ViewModel
   IComoEnviarMensagemParaOutraViewViewModel = interface(IViewModel)
         ['{D36C55A7-E017-4CDD-A3A8-77B6F7619134}']
