...
///  Object Factory para o ViewModel
    TRestODataAppViewModel=class(TViewModelFactory,
      IRestODataAppViewModel, IViewModelAs<IRestODataAppViewModel>)
    public
      function ViewModelAs:IRestODataAppViewModel;
      class function new():IRestODataAppViewModel;overload;
      class function new(const AController:IController):IRestODataAppViewModel; overload;
...
///   ligado
/// </param>
class function TRestODataAppViewModel.new(const AController:IController):IRestODataAppViewModel;
begin
