...
type
  ...
  // TQueryModelFactory<T: Class> � o construtor de Query
  // Generic:   T:Class � a classe decendente de TDataset ligado ao framework utilizado
  ...
  // Classe base para implementa��o de acesso a banco de dados
  // Onde     T: representa a classe de conex�o
...
begin
  ...
  if Assigned(FQuery) then
    if not TObject(FQuery).InheritsFrom(TDataset) then
      raise Exception.create('O tipo de classe n�o � uma heran�a de TDataset');
