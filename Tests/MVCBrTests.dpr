...
uses
  ...
  MVCBr.Controller,
   MVCBr.View,
   TestMVCBr.Observable in 'TestMVCBr.Observable.pas',
   TestMVCBr.ViewModel in 'TestMVCBr.ViewModel.pas',
   TestMVCBr.Controller in 'TestMVCBr.Controller.pas',
  TestMVCBrModel in 'TestMVCBrModel.pas',
   TestMVCBr.View in 'TestMVCBr.View.pas',
    TestMVCBr.FormView in 'TestMVCBr.FormView.pas',
   TestMVCBr.FrameView in 'TestMVCBr.FrameView.pas' {TestMVCBr.FrameView},
   TestMVCBr.PageView in 'TestMVCBr.PageView.pas',
   TestMVCBr.Patterns.States in 'TestMVCBr.Patterns.States.pas',
   TestMVCBr.Component in 'TestMVCBr.Component.pas',
   TestMVCBr.InterfaceHelper in 'TestMVCBr.InterfaceHelper.pas',
   TestMVCBr.Patterns.Strategy in 'TestMVCBr.Patterns.Strategy.pas',
   TestMVCBr.Patterns.Decorator in 'TestMVCBr.Patterns.Decorator.pas',
   TestMVCBr.Patterns.Adapter in 'TestMVCBr.Patterns.Adapter.pas',
   TestMVCBr.Patterns.Builder in 'TestMVCBr.Patterns.Builder.pas',
