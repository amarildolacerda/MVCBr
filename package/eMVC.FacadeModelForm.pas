...
procedure TFormNewFacadeModel.cbCreateModelClick(Sender: TObject);
begin
end;
...
procedure TFormNewFacadeModel.listClassNameClick(Sender: TObject);
begin
end;

procedure TFormNewFacadeModel.nbPageChanged(Sender: TObject);
begin
end;
