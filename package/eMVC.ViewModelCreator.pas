...
constructor TViewModelCreator.Create(const APath: string = ''; ABaseName: string = '';
...
function TViewModelCreator.NewImplSource(const ModuleIdent,
  FormIdent, AncestorIdent: string): IOTAFile;
begin
  Result := TFileCreator.Create(ModuleIdent, FormIdent, AncestorIdent, cVIEWMODEL);
end;
