...
-----------------------------------------------------------------------------}
unit eMVC.CastaliaSimplePasPar;
...
uses
  ...
  SysUtils,
  Classes,
  eMVC.CastaliaPasLexTypes,
  eMVC.CastaliaPasLex,
  eMVC.CastaliaSimplePasParTypes;

{$INCLUDE eMVC.CastaliaParserDefines.inc}
...
begin
  ...
  while not (TokenID in [ptType,ptNull]) do
       NextToken;
