[Files]
Source: "..\bin\MVCBrServerService.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\MVCBrServer\oData.ServiceModel.json"; DestDir: "{app}"; Flags: ignoreversion confirmoverwrite onlyifdoesntexist uninsneveruninstall
Source: "..\dados\MVCBR.FDB"; DestDir: "{app}"; Flags: ignoreversion

[Setup]
DefaultDirName={pf}\MVCBr
DisableWelcomePage=True
DisableReadyPage=True
DisableReadyMemo=True
DisableFinishedPage=True
AppName=MVCBrODataService
AppVersion=1.0
LanguageDetectionMethod=locale
DisableProgramGroupPage=yes
AppPublisher=MVCBr
AppPublisherURL=tireideletra.com.br
...
OutputDir=..\bin
OutputBaseFilename=MVCBrODataServiceSetup

[Run]
Filename: "{app}\MVCBrServerService.exe"; Parameters: "/uninstall"; WorkingDir: "{app}"; Description: "Install service"; Components: Service; Tasks: InstallService
Filename: "{app}\MVCBrServerService.exe"; Parameters: "/install"; WorkingDir: "{app}"; Description: "Install service"; Components: Service; Tasks: InstallService
Filename: "{app}\MVCBrServerService.exe"; Parameters: "/start"; WorkingDir: "{app}"; Components: Service; Tasks: StartService

[Types]
Name: "InstallService"; Description: "Install aka service"; Flags: iscustom

[Components]
Name: "Service"; Description: "Service"; Types: InstallService

[Tasks]
Name: "InstallService"; Description: "Install Service"; Components: Service
Name: "StartService"; Description: "Start Service"; Components: Service
...
begin
   result := true;
//	if IsServiceInstalled('MVCBr Service') = false then 
//  begin
//		if InstallService( expandConstant('{app}\MVCBrServerService.exe'),'MVCBr Service','MVCBr OData Service','MVCBr OData Service',SERVICE_WIN32_OWN_PROCESS,SERVICE_AUTO_START) = true then begin
//			StartService('MVCBr Service');
//			StopService('MVCBr Service');
			// after stopping a service you should wait some seconds before removing
//			RemoveService('MVCBr Service');
			// otherwise removing can fail
		//end
//	end
//	else 
//  if IsServiceRunning('MVCBr Service') then
//		MsgBox('MVCBr Service is running',mbInformation, MB_OK);
